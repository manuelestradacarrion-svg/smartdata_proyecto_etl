...
## Archivos CSV (subir al contenedor `raw` en ADLS Gen2) se suben por mes
...
- El nombre debe incluir el periodo en formato YYYYMM (ej: base_produccion_202601.csv) ya que este se tomará como parametro
